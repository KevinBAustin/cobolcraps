       ...
       01 GAME-OVER.
           05 BLANK SCREEN.
           05 LINE 22 COL 19 VALUE "GAME IS OVER.".
       01 GET-NAME.
           05 LINE 12 COL 1 VALUE "YOU MADE THE LEADERBOARD.".
           05 LINE 13 COL 1 VALUE "YOUR NAME:".
           05 LINE 13 COL 11 PIC X(20) USING PLAYER-NAME.
       ...
       SCORE-CHECK.
           ...
           IF PLAYERBAL IS EQUAL TO SCORE-TBL(LEAD-INDEX)
       ...
       LEADERBOARD.
           READ PLAYER-FILE-IN.
           DISPLAY PAST-PLAYER PAST-SCORE.
       ...
       PLAY-GAME.
           ...
           IF PHASE IS EQUAL TO 1
                   ...
                   SUBTRACT BETSUM FROM PLAYERBAL
                   PERFORM POINT-ROLL UNTIL PHASE IS EQUAL TO 0
           END-IF.
           MOVE 0 TO PHASE.
       ...
       COME-BETTING.
           ...
           MOVE 1 TO BETCHECK.
           MOVE 0 TO BETSUM.
           ADD BETDONTCOME TO BETCOME GIVING BETSUM.
           
           IF BETDONTCOME IS GREATER THAN MAXBET
                   MOVE 2 TO BETCHECK.
           IF BETCOME IS GREATER THAN MAXBET
                   MOVE 2 TO BETCHECK.
           IF BETDONTCOME IS LESS THAN MINBET AND IS NOT EQUAL TO ZERO
                   MOVE 2 TO BETCHECK.
           IF BETCOME IS LESS THAN MINBET AND IS NOT EQUAL TO ZERO
                   MOVE 2 TO BETCHECK.
       ...
       POINT-BETTING.
           ...
           MOVE 1 TO BETCHECK.
           MOVE 0 TO BETSUM.
           ADD BETDONTPASS TO BETPASS GIVING BETSUM.

           IF BETDONTPASS IS GREATER THAN MAXBET
                   MOVE 2 TO BETCHECK
           ELSE IF BETPASS IS GREATER THAN MAXBET
                   MOVE 2 TO BETCHECK
           ELSE IF BETDONTPASS IS LESS THAN MINBET
                   MOVE 2 TO BETCHECK
           ELSE IF BETPASS IS LESS THAN MINBET
                   MOVE 2 TO BETCHECK
       ...
       POINT-ROLL.
           ...
           PERFORM PUCK-CHECK.
           PERFORM ROLL-CHECK2.
           SUBTRACT SKIP-1 FROM SKIP-2 GIVING PHASE.
